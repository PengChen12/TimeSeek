...
from src.models.layers.MOE_scale_layer import MOE_layers, layers
...
class GenTS(nn.Module):
    ...
    def __init__(self, c_in: int, target_dim: int, patch_len: int, stride: int, num_patch: int,
        ...
        ###gate的融合方式
        self.gatelayer1 = GateLayer_add(d_model)
        self.gatelayer2 = GateLayer_add(d_model)
