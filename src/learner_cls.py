...
from .callback.tracking_cls import * 
...
class Learner(GetAttr):
    ...
    def unfreeze(self):
        ...
        # for param in get_model(self.model).image_encoder.encoder.heads[0].parameters(): param.requires_grad = True      
...
def transfer_weights(weights_path, model, exclude_head=True, device='cuda:0'):
    ...
    new_state_dict = {k: v for k, v in new_state_dict.items() if k != 'n_averaged'}
