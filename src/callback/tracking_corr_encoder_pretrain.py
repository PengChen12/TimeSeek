...
class TrackTrainingCB(Callback):
    ...
    def initialize_recorder(self):
        recorder = {'epoch': [],  'train_loss': [], 'train_contrastive_loss':[]} 
        if self.valid_loss: 
            recorder['valid_loss'] = []
            recorder['valid_contrastive_loss'] = []
    ...
    def initialize_batch_recorder(self, with_metrics):
        batch_recorder = {'n_samples': [], 'batch_losses': [], 'batch_contrastive_losses': [],'with_metrics': with_metrics}                                                         
    ...
    def accumulate(self ):
        ...
        contrastive_loss = self.contrastive_loss.detach()*bs if self.mean_reduction_ else self.self.batch_recorder['batch_losses'].append(loss).detach() 
        ...
        if self.iter % 500 == 0:
            ...
            print(f"{self.iter} iter loss: {cur_loss:.4f}")
    ...
    def compute_scores(self):
        ...
        values['contrastive_loss'] = sum(self.batch_recorder['batch_contrastive_losses']).item()/n  # averaging
